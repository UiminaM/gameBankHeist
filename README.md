...
Команда из четырёх LLM-агентов (World State Agent, Strategist, Hacker, Robber) совместно моделирует ограбление банка на сгенерированной 2D-карте. Игрок задаёт уровень сложности и наблюдает партию в Pygame UI.
